...
plot(ecdf(norm_median), do.points = F, col = "green")
...
```{r}
hist(norm_median, freq = FALSE, main = "The distribution of the mean of standard normal distribution", breaks = 50)
...
y <- quantile(norm_median, probs = (1:200)/200)
