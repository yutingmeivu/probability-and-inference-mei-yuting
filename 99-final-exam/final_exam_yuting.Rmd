...
rlnorm(101, 0, 1) %>% quantile(.55)
)
plot(density(sample_25), main = "Density of different percentile of log normal distribution", col = "blue", xlim = c(0.1,1.8),
     ylim = c(0,6.5), xlab = "")
par(new=TRUE)
plot(density(sample_l), col = "orange", main = ' ',xlab = "", xlim = c(0.1,1.8), ylim = c(0,6.5))
par(new=TRUE)
plot(density(sample_75), col = "green", main = '',xlab = "", xlim = c(0.1,1.8), ylim = c(0,6.5))
legend(
  "topright",
...
```{r}
# The first one. Because the equivalence threshold fall in the 95%CI of that study.
```
