...
# Walk out money distribution
hist(times_run_out_money, breaks = 100)
```
The picture above shows the average number of stops under 1000 simulations. The average value of simulation stops is about 200 times.
